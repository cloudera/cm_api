 ...
 */
@XmlRootElement(name = "watchedDirList")
public class ApiWatchedDirList extends ApiListBase<ApiWatchedDir> {
  private List<ApiWatchedDir> watchedDirs = Lists.newArrayList();

  public ApiWatchedDirList() {
    // For JAX-B.
  }

  public void addWatchedDir(String dir) {
    watchedDirs.add(new ApiWatchedDir(dir));
  }
