...
public class ApiImpalaUtilization {
  ...
  public void setSuccessfulQueriesPercentage(
      Double successfulQueriesPercentage) {
  ...
  public void setOomQueriesPercentage(
      Double oomQueriesPercentage) {
  ...
  public void setTimeOutQueriesPercentage(
      Double timeOutQueriesPercentage) {
  ...
  public void setRejectedQueriesPercentage(
      Double rejectedQueriesPercentage) {
  ...
  public void setDistributionUtilizedByImpalaDaemon(
      ApiImpalaUtilizationHistogram distributionUtilizedByImpalaDaemon) {
  ...
  public void setDistributionAllocatedByImpalaDaemon(
      ApiImpalaUtilizationHistogram distributionAllocatedByImpalaDaemon) {
  ...
  public void setTenantUtilizations(
      ApiImpalaTenantUtilizationList tenantUtilizations) {
  ...
  public String toString() {
    return Objects.toStringHelper(this)
        ...
        .add("successfulQueriesPercentage", successfulQueriesPercentage)
        .add("oomQueriesPercentage", oomQueriesPercentage)
        .add("timeOutQueriesPercentage", timeOutQueriesPercentage)
        .add("rejectedQueriesPercentage", rejectedQueriesPercentage)
