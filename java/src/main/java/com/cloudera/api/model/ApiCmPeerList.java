 ...
 */
@XmlRootElement(name = "cmPeerList")
public class ApiCmPeerList extends ApiListBase<ApiCmPeer> {

  public ApiCmPeerList() {
    // For JAX-B.
  }

  public ApiCmPeerList(List<ApiCmPeer> peers) {
    super(peers);
  }


  @XmlElementWrapper(name = ApiListBase.ITEMS_ATTR)
  @XmlElement(name = "cmPeer")
