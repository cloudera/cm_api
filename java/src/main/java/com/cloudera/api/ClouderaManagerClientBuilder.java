      ...
      .build(
        new CacheLoader<Class<?>, JAXRSClientFactoryBean>(){
          ...
          public JAXRSClientFactoryBean load(Class<?> proxyType) throws Exception {
            ...
            // Configuring the deserialization to not fail on unknown properties.
            // This ensures backward compatibility of APIs especially with BDR. OPSAPS-45062
            clientFactoryBean.setProvider(new JacksonJsonProvider((
              new ApiObjectMapper()).configure(
